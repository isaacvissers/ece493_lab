...
test('blocks decision entry when fewer than three reviews exist', () => {
  assignmentStorage.seedPaper({ id: 'paper_few', title: 'Paper', status: 'submitted', editorId: 'editor_1' });
  seedReviews([
    { paperId: 'paper_few', status: 'submitted' },
    { paperId: 'paper_few', status: 'submitted' },
  ]);

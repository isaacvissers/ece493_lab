...
test('blocks edits outside the conference time window', () => {
  const conference = createConference({
    conferenceId: 'conf_window',
  ...
  view.element.querySelector('#editStartTime').value = '2026-05-01T13:00';
  view.element.querySelector('#editEndTime').value = '2026-05-01T13:30';
  ...
  expect(view.element.textContent).toContain('window');
});
